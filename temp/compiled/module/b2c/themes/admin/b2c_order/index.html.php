	...
	<body >
		...
		<div class="main-body">
			<form autocomplete="off" class="search-form" action="/moduleadmin.php"> 
				<input type="hidden" name="m" value="b2c_order">
...
?>
					...
					<div  class="flex flex-jc-end">
						...
						<div class="btn-small  btn-outline-danger" gourl="/moduleadmin.php?m=b2c_order&a=show&orderid=<?php echo $this->_var['item']['orderid']; ?>">查看</div>
					</div>

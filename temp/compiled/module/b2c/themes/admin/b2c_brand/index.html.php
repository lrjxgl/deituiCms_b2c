...
<html>
	...
	<body>
<?php echo $this->fetch('b2c_brand/nav.html'); ?>
<div class="main-body">
 <table class="tbs">
<thead>  <tr>
   <td>brandid</td>
...
<td><a href="moduleadmin.php?m=b2c_brand&a=add&brandid=<?php echo $this->_var['c']['brandid']; ?>">编辑</a> <a target="_blank" href="/module.php?m=b2c_brand&a=show&brandid=<?php echo $this->_var['c']['brandid']; ?>">查看</a> <a href="javascript:;" class="js-delete" url="moduleadmin.php?m=b2c_brand&a=delete&ajax=1&brandid=<?php echo $this->_var['c']['brandid']; ?>">删除</a></td>
  </tr>
